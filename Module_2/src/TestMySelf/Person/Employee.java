...
public class Employee extends Person {
    ...
    public Employee(int id, String name, String dateOfBirth, String gender, String identityNumber,
                    String phoneNumber, String email, String education, String position, double salary) {
    ...
    public String toString() {
        return super.toString()+", education="+education+", position="+position+", salary="+salary;
    }
}
