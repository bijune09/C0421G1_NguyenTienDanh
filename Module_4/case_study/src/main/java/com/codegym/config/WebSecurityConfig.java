...
import com.codegym.model.service.user.MyUserDetailServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .and()
                .authorizeRequests().antMatchers("/","/customers**","/contracts**","/services**").permitAll()
                .and()
                .authorizeRequests().antMatchers("/employees**").hasAnyRole("DIRECTOR","SUPERVISOR")
