...
public class ProductController {
    ...
    public String advanced(@RequestParam(name = "name",required = false) String name,
                           @RequestParam(name = "price1",required = false) String price1,
                           @RequestParam(name = "price2",required = false) String price2,
                           Model model){
        model.addAttribute("productList",this.productService.findByNameContainingOrCostBetween(name,price1,price2));
        return "/list";
    }
}
